    ...
    public partial class mig3 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Products", x => x.HaberId);
                });
            ...
            migrationBuilder.InsertData(
                table: "Products",
                columns: new[] { "HaberId", "HaberBaslik", "IsActive", "Tarih" },
                values: new object[,]
                {
                    { 1, "Gündem", true, "10.03.2024" },
                    { 2, "Tarih", false, "06.01.2023" },
                    { 3, "Borsa", true, "07.05.2024" },
                    { 4, "Magazin", true, "18.11.2023" }
                });
